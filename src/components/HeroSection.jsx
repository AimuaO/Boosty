...
const HeroSection = () => {
  return (
    <section className="h-1/2 lg:min-h-[60vh] bg-boosty_yellow mt-0 lg:mt-[80px] grid grid-cols-1 lg:grid-cols-2 place-items-center place-content-center gap-14 px-16 md:px-36 py-20 lg:pt-0">
