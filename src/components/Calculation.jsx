...
const Calculation = () => {
  return (
    <section className="text-white">
      <div className="w-full lg:w-[95%] bg-boosty_green py-12 lg:py-20 pl-10 lg:pl-36 pr-10 lg:pr-20 grid grid-cols-1 lg:grid-cols-2 place-content-center place-items-center rounded-r-[15px] lg:rounded-r-[35px]">
