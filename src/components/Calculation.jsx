...
const Calculation = () => {
  return (
    <section className="text-white">
      <div className="w-full lg:w-[95%] bg-boosty_green py-12 md:py-20 pl-10 md:pl-[7.2rem] pr-10 md:pr-20 grid grid-cols-1 lg:grid-cols-2 place-content-start lg:place-content-center place-items-start lg:place-items-center gap-14 rounded-r-[15px] lg:rounded-r-[15px]">
        <div className="mb-10 lg:mb-0">
          <h2 className="text-[35px] font-[700] leading-[45px] mb-6">
            From Calculation to <br /> Installation in 3 Simple <br />
            Steps
          </h2>
